...
from common.models import GRUClassifier
...
def main():
    parser = argparse.ArgumentParser(description="Train GRU encoder classifier for addition NLP task.")
    parser.add_argument("--data-dir", type=str, default="data/addition")
    parser.add_argument("--out-dir", type=str, default="outputs/gru_classifier")
    ...
    model = GRUClassifier(vocab_size=len(INPUT_VOCAB))
    logger = create_logger(Path(args.out_dir), name="gru_cls")
