...
from common.models import LSTMSeq2Seq
...
def main():
    parser = argparse.ArgumentParser(description="Train LSTM Seq2Seq for addition NLP task.")
    parser.add_argument("--data-dir", type=str, default="data/addition")
    parser.add_argument("--out-dir", type=str, default="outputs/lstm_seq2seq")
    ...
    model = LSTMSeq2Seq(src_vocab_size=src_vocab_size, tgt_vocab_size=tgt_vocab_size)
    logger = create_logger(Path(args.out_dir), name="lstm_seq2seq")
