...
from common.models import LSTMClassifier
...
def main():
    parser = argparse.ArgumentParser(description="Train LSTM encoder classifier for addition NLP task.")
    parser.add_argument("--data-dir", type=str, default="data/addition")
    parser.add_argument("--out-dir", type=str, default="outputs/lstm_classifier")
    ...
    model = LSTMClassifier(vocab_size=len(INPUT_VOCAB))
    logger = create_logger(Path(args.out_dir), name="lstm_cls")
