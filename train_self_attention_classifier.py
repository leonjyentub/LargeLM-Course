...
from common.models import SelfAttentionClassifier
...
def main():
    parser = argparse.ArgumentParser(description="Train self-attention classifier for addition NLP task.")
    parser.add_argument("--data-dir", type=str, default="data/addition")
    parser.add_argument("--out-dir", type=str, default="outputs/self_attention_classifier")
    ...
    model = SelfAttentionClassifier(vocab_size=len(INPUT_VOCAB))
    logger = create_logger(Path(args.out_dir), name="sa_cls")
